...
import com.daentech.core.BRDFs.SV_Specular;
...
public class SV_Phong extends Material {
	...
	public SV_Lambertian ambient_brdf = new SV_Lambertian();
	public SV_Lambertian diffuse_brdf = new SV_Lambertian();
	public SV_Specular specular_brdf = new SV_Specular();
	...
	public void set_cd(Texture colour) {
